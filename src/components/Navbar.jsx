    ...
    <nav className="bg-gray-950 text-sky-400 shadow-md w-full z-100">
      ...
      {isOpen && (
        <div className={`md:hidden bg-gray-900 text-sky-400 py-2 px-6 space-y-2 text-left`}>
          <a href="#about" className="w-1/3 block border-b rounded-md pb-2 pl-3 hover:text-white">Home</a>
          <a href="#education" className="w-1/3 block border-b rounded-md pb-2 pl-3 hover:text-white">Education</a>
          <a href="#skills" className="w-1/3 block border-b rounded-md pb-2 pl-3 hover:text-white">Skills</a>
          <a href="#projects" className="w-1/3 block border-b rounded-md pb-2 pl-3 hover:text-white">Projects</a>
