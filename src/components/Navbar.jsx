    ...
    <nav className="bg-gray-950 text-sky-400 shadow-md w-full z-100">
      ...
      {isOpen && (
        <div className={`md:hidden bg-gray-900 text-sky-400 py-3 px-6 space-y-3 text-left`}>
          <a href="#about" className="block border-b border-white pb-2 hover:text-white">Home</a>
          <a href="#education" className="block border-b border-white pb-2 hover:text-white">Education</a>
          <a href="#skills" className="block border-b border-white pb-2 hover:text-white">Skills</a>
          <a href="#projects" className="block border-b border-white pb-2 hover:text-white">Projects</a>
